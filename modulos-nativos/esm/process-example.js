// Módulo Process de Node.js (ES Modules)

// ✅ Buena práctica: importar explícitamente (Node.js 16+)
import process from 'node:process';

console.log('=== Módulo Process de Node.js (ES Modules) ===\n');
...
console.log('\n📝 MEJORES PRÁCTICAS:\n');
console.log('   ✅ Importar explícitamente: import process from "node:process"');
...
console.log('   • Sintaxis import más moderna y clara');
console.log('   • Mejor compatibilidad con herramientas modernas');
console.log('   • Top-level await disponible');
