// Listar Directorios (como comando ls) - ES Modules
...
console.log('=== Listar Directorios (comando ls en Node.js - ESM) ===\n');
...
console.log('   • Sintaxis import moderna');
console.log('   • Compatible con Top-level await');
console.log('   • Mejor integración con herramientas modernas');
