// Ejecución Paralela vs Secuencial en Node.js (ES Modules)
...
console.log('   • Top-level await permite código más limpio');
console.log('   • No necesitas wrappers async function');
console.log('   • Código más legible y moderno');
