// Operaciones SÍNCRONAS con fs - CommonJS
// Las operaciones síncronas BLOQUEAN la ejecución hasta completarse

const fs = require('node:fs');
const path = require('node:path');

console.log('=== Operaciones SÍNCRONAS (Bloqueantes) - CommonJS ===\n');
